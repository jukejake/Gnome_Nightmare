...
namespace Random_Utils {
    ...
    public class RandomUtils : MonoBehaviour {
        ...
        static public float RandomFloat(int min, int max) { return Random.Range(min, max+1.0f); }
        ...
        static public int RandomInt(float min, float max) { return (int)Random.Range(min, max+1); }
