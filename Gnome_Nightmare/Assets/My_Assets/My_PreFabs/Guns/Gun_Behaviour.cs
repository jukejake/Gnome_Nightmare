...
public class Gun_Behaviour : SerializedMonoBehaviour {
    ...
    [ToggleGroup("WeaponTypeMelee", order: 3, groupTitle: "Melee")]
    public bool WeaponTypeMelee;
    ...
    //            newStat.stat = (Stat.StatType)i;
    //            OrderedStats.Add(newStat);
    //        }
    //    }
    //    Stats = OrderedStats;
    //    GetStats();
    ...
    //    foreach (Stat item in Stats) {
    //        if (item.stat == Stat.StatType.Damage) { Damage = item.GetValue(); }
    //        else if (item.stat == Stat.StatType.Range) { Range = item.GetValue(); }
    //        else if (item.stat == Stat.StatType.ClipSize) { ClipSize = (int)item.GetValue(); }
    //        else if (item.stat == Stat.StatType.AmountCount) { AmountCount = (int)item.GetValue(); }
    //        else if (item.stat == Stat.StatType.FireRate) { FireRate = item.GetValue(); }
    //        else if (item.stat == Stat.StatType.ReloadTime) { ReloadTime = item.GetValue(); }
    //        else if (item.stat == Stat.StatType.ImpactForce) { ImpactForce = item.GetValue(); }
    //    }
    //}
    //public void SetStats() {
    //    for (int i = 0; i < Stats.NumberOfStatsInTable; i++) {
    //        Stats.Damage.baseValue = Damage; 
    //        Stats.Range.baseValue = Range; 
    //        Stats.ClipSize.baseValue = ClipSize; 
    //        Stats.AmountCount.baseValue = AmountCount; 
    //        Stats.FireRate.baseValue = FireRate; 
    //        Stats.ReloadTime.baseValue = ReloadTime;
    //        Stats.ImpactForce.baseValue = ImpactForce;
    //    }
    //}
}
